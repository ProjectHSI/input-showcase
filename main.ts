...
basic.forever(function () {
    ...
    if (!isVersionDisplay) {
        ...
        // These last few ifs have no radio sending, 
        // this is because we don't have the space on the line to send the data over to another Micro:Bit
...
input.onButtonPressed(Button.AB, function() {
    ...
    isVersionDisplay = true

    basic.showString("1.0")

    isVersionDisplay = false
